...
print("本程序由个人编写，维护和更新，版本更新网址 https://github.com/lu-wang-github/python_for_sci-hub，若程序闪退，请发邮件反馈 1757765654@qq.com")
count = 0
for count in range(1000):
    count += 1
    print('\n'+ "执行第" + str(count) + "次下载" + '\n')
    doi = input("请输入文献doi号后回车：")
    print('\n' + "正在检索下载pdf文件，请耐心等待10秒......")
    ...
    try:
        ...
        print("状态码" + str(r.status_code) + ",获取pdf失败,请再次尝试下载，或联系1757765654@qq.com")
    sleep(0.5)
    ...
    if "article not found" in r.text:
        ...
        # 上面的代码已经获取pdf文件的url，接下来对其进行下载(requests.get)
            try:
                ...
                print("状态码" + str(r.status_code) + ",请再次尝试下载，或联系1757765654@qq.com")
